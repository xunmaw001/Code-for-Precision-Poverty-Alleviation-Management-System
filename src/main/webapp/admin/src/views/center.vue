  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='ganbu'"  label='干部邮箱' prop="ganbuEmail">
               <el-input v-model="ruleForm.ganbuEmail"  placeholder='干部邮箱' clearable></el-input>
           </el-form-item>
         </el-col>
...
|| flag=='ganbu')"  label="性别" prop="sexTypes">

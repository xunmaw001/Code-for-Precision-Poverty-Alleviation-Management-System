    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="sessionTable !='ganbu' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.ganbuPhoto" label="干部头像" prop="ganbuPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ganbuForm.ganbuPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.ganbuPhoto" label="干部头像" prop="ganbuPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.ganbuPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='ganbu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="干部邮箱" prop="ganbuEmail">
                        <el-input v-model="ganbuForm.ganbuEmail"
                                  placeholder="干部邮箱" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="干部邮箱" prop="ganbuEmail">
                            <el-input v-model="ruleForm.ganbuEmail"
                                      placeholder="干部邮箱" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <el-col :span="12" v-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.huodongYuyueFile" label="附件" prop="huodongYuyueFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.huodongYuyueFile?$base.url+ruleForm.huodongYuyueFile:''"
                                @change="huodongYuyueFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.huodongYuyueFile" label="附件" prop="huodongYuyueFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.huodongYuyueFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            //图片
            huodongYuyueFileUploadChange(fileUrls){
                this.ruleForm.huodongYuyueFile = fileUrls;
                this.addEditUploadStyleChange()
            },

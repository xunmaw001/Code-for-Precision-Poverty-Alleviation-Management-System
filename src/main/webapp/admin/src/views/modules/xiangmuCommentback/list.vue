                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jingzhunfupinguanlixitong/upload/xiangmuCommentbackMuBan.xls"
                        >批量导入项目评价数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('xiangmuCommentback','导入导出')"
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'xiangmu_commentback',//当前表表名,
                        sumColum : 'xiangmu_commentback_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'xiangmu_commentback_name',//分组字符串字段
                        // types : 'xiangmu_commentback_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //     var statistic = this.$echarts.init(document.getElementById("statistic"),'macarons');
                //     let params = {
                //         tableName: "xiangmu_commentback",
                //         groupColumn: "xiangmu_commentback_types",
                //// riqi :getMonthFormat(_this.echartsDate),//年月
                //     }
                //     this.$http({
            ...
            wuyong(id) {
                ...
                _this.$confirm(`确定    操作?`, "提示", {confirmButtonText: "确定",cancelButtonText: "取消",type: "warning"
                    ...
                    _this.$http({
                        url: "xiangmuCommentback/update",
                        method: "post",
                        data: {
                            id:id,
//                            xiangmuCommentbackTypes:xiangmuCommentbackTypes,
                        }
                    }).then(({data}) => {
                        if(data && data.code === 0){

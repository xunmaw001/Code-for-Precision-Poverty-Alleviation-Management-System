    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">精准扶贫管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item v-if="ganbuPhotoFlag">
                            </el-form-item>
                            <el-form-item label="干部头像" class="input" v-if="tableName=='ganbu'">
                                    <file-upload
                                        tip="点击上传干部头像"
                                        action="file/upload"
                                        :limit="1"
                                        :multiple="true"
                                        :fileUrls="ruleForm.ganbuPhoto?$base.url+ruleForm.ganbuPhoto:''"
                                        @change="ganbuPhotoUploadChange"
                                    ></file-upload>
                           </el-form-item>
                        -->
                        <el-form-item label="干部邮箱" class="input" v-if="tableName=='ganbu'">
                            <el-input v-model="ruleForm.ganbuEmail" autocomplete="off" placeholder="干部邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='ganbu'">
        ...
        methods: {
            ...
            ganbuPhotoUploadChange(fileUrls) {
               this.ruleForm.ganbuPhoto = fileUrls;
                if(this.ganbuPhotoFlag){
                    this.ganbuPhotoFlag=false;
                }else{
                    this.ganbuPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            // ganbu 中的 干部头像 判空处理
                            // if('ganbu' == this.tableName && (this.ruleForm.ganbuPhoto== null ||this.ruleForm.ganbuPhoto== "")){
                            ...
                            // ganbu 中的 创建时间 判空处理
                            // if('ganbu' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){

...
public class GanbuLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public GanbuLiuyanEntity() {

	}

	public GanbuLiuyanEntity(T t) {
		try {
    ...
    @TableField(value = "ganbu_liuyan_text")

    private String ganbuLiuyanText;
	 ...
	 * 获取：留言内容
	 */
    public String getGanbuLiuyanText() {
        return ganbuLiuyanText;
    }
    /**
	 * 设置：留言内容
	 */

    public void setGanbuLiuyanText(String ganbuLiuyanText) {
        this.ganbuLiuyanText = ganbuLiuyanText;
    }
    /**
	 * 获取：留言时间
	 */
    ...
    public String toString() {
        return "GanbuLiuyan{" +
            ...
            ", ganbuId=" + ganbuId +
            ", yonghuId=" + yonghuId +
            ", ganbuLiuyanText=" + ganbuLiuyanText +

...
public class GanbuLiuyanView extends GanbuLiuyanEntity implements Serializable {
	...
	public GanbuLiuyanView() {

	}

	public GanbuLiuyanView(GanbuLiuyanEntity ganbuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, ganbuLiuyanEntity);

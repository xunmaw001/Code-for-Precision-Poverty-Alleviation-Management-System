...
public class XiangmuCommentbackView extends XiangmuCommentbackEntity implements Serializable {
	...
	public XiangmuCommentbackView() {

	}

	public XiangmuCommentbackView(XiangmuCommentbackEntity xiangmuCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, xiangmuCommentbackEntity);

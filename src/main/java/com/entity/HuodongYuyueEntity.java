...
public class HuodongYuyueEntity<T> implements Serializable {
    ...
    @TableField(value = "huodong_yuyue_file")

    private String huodongYuyueFile;
	 ...
	 * 获取：附件
	 */
    public String getHuodongYuyueFile() {
        return huodongYuyueFile;
    }
    /**
	 * 设置：附件
	 */

    public void setHuodongYuyueFile(String huodongYuyueFile) {
        this.huodongYuyueFile = huodongYuyueFile;
    }
    /**
	 * 获取：审核回复
	 */
    ...
    public String toString() {
        return "HuodongYuyue{" +
            ...
            ", huodongYuyueFile=" + huodongYuyueFile +
